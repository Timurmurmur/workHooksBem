                ...
                <Container comp="main" type="wrapper">
                    <div className="wrapper wrapper_comp_card card_type_task">
                        ...
                        <Container type="wrapper" comp="cardHeaderNav">
                            <ul>
                                <li>
                                    <Link href='#' comp="main" color="gray" size="normal"><span>НОВЫЕ</span></Link>
                                </li>
                                <li>
                                    <Link href='#' comp="main" color="gray" size="normal"><span>НА ОЦЕНКЕ</span></Link>
                                </li>
                                <li>
                                    <Link href='#' comp="main" color="blue" size="normal" checked><span>НА ТЕСТИРОВАНИИ</span></Link>
                                </li>
                                <li>
                                    <Link href='#' comp="main" color="gray" size="normal"><span>ВОЗРАЩЕНЫ НА ДОРАБОТКУ</span></Link>
                                </li>
                                <li>
                                    <Link href='#' comp="main" color="gray" size="normal"><span>В ОЖИДАНИИ</span></Link>
                                </li>
                                <li>
                                    <Link href='#' comp="main" color="gray" size="normal"><span>ОТКАЗ</span></Link>
                                </li>
                                <li>
                                    <Link href='#' comp="main" color="gray" size="normal"><span>ИСПОЛНЕНЫ</span></Link>
                                </li>
                                <li>
                                    <Link href='#' comp="main" color="gray" size="normal"><span>ЗАКРЫТЫ</span></Link>
                                </li>
                                <li>
                                    <Link href='#' comp="main" color="gray" size="normal"><span>ВСЕ</span></Link>
                                </li>
                            </ul>
                        </Container>
                        <Container comp="cardContent" type="wrapper">
                            <table className="table table_comp_cardContent">
                                <tr className="table-colnaming">
                                    <th className="table-colname"><span>НАИМЕНОВАНИЕ ЗАДАЧИ</span></th>
                                    <th className="table-colname"><span>ДАТА НАЧАЛА</span></th>
                                    <th className="table-colname"><span>ДЭДЛАЙН</span></th>
                                    <th className="table-colname"><span>ПЛАН, Ч.</span></th>
                                    <th className="table-colname"><span>ФАКТ, Ч.</span></th>
                                    <th className="table-colname"><span>ПРОЕКТ/КЛИЕНТ</span></th>
                                    <th className="table-colname"><span>КОММЕНТАРИЙ</span></th>
                                </tr>
                                <tr className="table-colvalues">
                                    <th><span className="table-name">Название первой задачи, которую необходимо выполнить в срок</span></th>
                                    <th><span className="table-start">10.11.2016<br/>14:11:00</span></th>
                                    <th><span className="table-deadline">10.11.2016<br/>14:11:00</span></th>
                                    <th><span className="table-planch">10</span></th>
                                    <th><span className="table-facktch">10</span></th>
                                    <th><span className="table-client">Клиент 1</span></th>
                                    <th><span className="table-comment">Последний комментарий к поставленной задаче</span></th>
                                </tr>
                                <tr className="table-colvalues">
                                    <th><span className="table-name">Название первой задачи, которую необходимо выполнить в срок</span></th>
                                    <th><span className="table-start">10.11.2016<br/>14:11:00</span></th>
                    ...
                    <Container type="wrapper" comp="card">
                        <div className="card_header">
                            ...
                            <Container type="wrapper" comp="cardHeaderNav">
                                <ul>
                                    <li>
                                        <Link href='#' comp="main" color="blue" size="normal" checked><span>День</span></Link>

                                    </li>
                                    <li>
                                        <Link href='#' comp="main" color="gray" size="normal"><span>Неделя</span></Link>
                                    </li>
                                    <li>
                                        <Link href='#' comp="main" color="gray" size="normal"><span>Месяц</span></Link>
                                    </li>
                                </ul>
                            </Container>
                            <div className="card_header__options">
                        ...
                        <Container comp="stat" type="container">
                            ...
                            <div className="wrapper wrapper_comp_stat stat_type_profit">
                                ...
                                <div className="stat_yesterday">
                                    <span className="stat_yesterday__title">За прошлый день:</span>
                                    <p>$ 50 000</p>
                                </div>
                            </div>
                    ...
                    <div className="wrapper wrapper_comp_card card_type_count">
                        ...
                        <Container type="wrapper" comp="cardHeaderNav">
                            <ul>
                                ...
                                <li>
                                    <Link href='#' comp="main" color="gray" size="normal"><span>ОПЛАЧЕННЫЕ</span></Link>
                                </li>
                                <li>
                                    <Link href='#' comp="main" color="blue" size="normal" checked><span>НЕОПЛАЧЕННЫЕ</span></Link>
                                </li>
                                <li>
                                    <Link href='#' comp="main" color="gray" size="normal"><span>ПРОСРОЧЕННЫЕ</span></Link>
                                </li>
                                <li>
                                    <Link href='#' comp="main" color="gray" size="normal"><span>ВСЕ</span></Link>
                                </li>
