...
export const NewCount: React.FC = () => {
          ...
          <div className="compTitle__left">
            {router.params.type === "income" ? (
              <>
                ...
                <span>
                  Зарегистрируйте новый счет от поставщика, чтобы контролировать
                  его оплату и Ваши финансовые потоки
                </span>
              </>
            ) : (
              <>
                ...
                <span>
                  Создайте новый счет на оплату от покупателя, чтобы
                  контролировать его оплату и Ваши финансовые потоки
                </span>
              </>
            )}
          </div>
          ...
          <table className="newCountTable newCountTable_count_first">
            ...
            <tr className="newCount__input">
              ...
              <th>
                <Select
                  comp="newCount"
                  options={["Введите наименование организации"]}
                />
              </th>
            </tr>
            <tr className="newCount__input">
              ...
              <th>
                <Select
                  comp="newCount"
                  options={["Введите наименование поставщика"]}
                />
              </th>
            </tr>
            <tr className="newCount__input">
        ...
        <div className="wrapper wrapper_comp_card container_conp_newCount newCount_count_third">
          <div className="wrapper wrapper_comp_comment">
            ...
            <textarea
              cols={30}
              rows={7}
              placeholder="Введите комментарий к счету"
            ></textarea>
          </div>
          <div className="wrapper wrapper_comp_newCountBtnLine">
            <Button comp="newCountBtnLine" color="blue" size="normal">
              <span>СОХРАНИТЬ</span>
            </Button>
            <Button comp="newCountBtnLine" color="blue" size="normal">
              <span>СОХРАНИТЬ И ОТПРАВИТЬ</span>
            </Button>
            <Button comp="newCountBtnLine" color="gray" size="normal">
              <span>ОТМЕНА</span>
            </Button>
