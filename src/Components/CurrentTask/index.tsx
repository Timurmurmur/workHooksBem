                ...
                <div className="wrapper wrapper_comp_TaskCurrent ">
                    <div className="wrapper wrapper_comp_card">
                        ...
                        <div className="TaskCurrent__description">
                            <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum rhoncus vulputate purus, vitae lobortis est. Duis aliquet nisl nec elit tincidunt malesuada. Suspendisse fringilla, leo at tristique euismod, mi libero pellentesque libero, nec scelerisque justo ipsum a purus. Duis nec metus efficitur, suscipit metus egestas, accumsan nibh. Nunc vel sapien ut lacus rhoncus porta. Proin ante libero, ultrices sed massa eget, ornare condimentum est. Maecenas ornare ante a risus fringilla laoreet. Nunc vel tristique nisi. Quisque luctus, turpis vel tristique lobortis, mauris lectus ornare erat, id commodo nunc enim non tellus. Integer mauris felis, vehicula sit amet bibendum ac, tempus a enim. Sed ut orci leo. Pellentesque  eget ex non massa consectetur pulvinar. Donec a commodo turpis, dignissim mollis dolor. Nullam rutrum sodales auctor. Sed leo ante, blandit sit amet euismod in, vehicula a ipsum.</span>
                        </div>
                        ...
                        <div className="TaskCurrent__options">
                            <Button comp="TaskCurrent" size="normal" color="green">НАЧАТЬ ВЫПОЛНЕНИЕ</Button>
                            <Button comp="TaskCurrent" size="normal" color="green">ЗАВЕРШИТЬ</Button>
                            <Button comp="TaskCurrent" size="small" color="gray">ЕЩЕ</Button>
                        ...
                        <div className="TaskCurrent__nav wrapper wrapper_comp_compNav">
                            {
                                ...
                                <ul>
                                    <li className="TaskCurrent__selected">
                                        <span onClick={event => this.renderHistory(event)} className="component-nav_current">КОММЕНТАРИИ<div>10</div></span>
                                    </li>
                                    <li>
                                        <span onClick={event => this.renderHistory(event)} className="component-nav_current">ИСТОРИЯ<div>10</div></span>
                                    </li>
                                </ul>
                                :
                                <ul>
                    ...
                    <div className="task-stat__main">
                        <table>
                            <tr className="task-stat__block">
                                <th><span>Крайний срок</span></th>
                                <th><span>20.03.2019 19:00</span></th>
                            </tr>
                            <tr className="task-stat__block">
                                <th><span>Поставлена</span></th>
                                <th><span>20.03.2019 09:00</span></th>
                            </tr>
                            <tr className="task-stat__block">
                                <th><span>Выделено</span></th>
                                <th><span>20:00:00</span></th>
                            </tr>
                            <tr className="task-stat__block">
                                <th><span>Затрачено</span></th>
                                <th><span>09:04:51</span></th>
                            </tr>
                            <tr className="task-stat__block">
                                <th><span>Выполнено на</span></th>
                                <th><span>15%</span></th>
                            </tr>
                            <tr className="task-stat__block">
                                <th><span>Стадия</span></th>
